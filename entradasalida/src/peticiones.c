...
//!SI FALTABA ARMARLAS
void ejecutarFS_CREATE(t_log* logger, int conexionKernel, int conexionMemoria)
{
    /*
    t_peticion_std peticion = recibirDireccionFisicaYPID(conexionKernel, logger);

    log_info(logger, "PID: <%d> - Operacion: <FS_CREATE>", peticion.PID);
...
void ejecutarFS_DELETE(t_log* logger, int conexionKernel, int conexionMemoria)
{
    /*
    t_peticion_std peticion = recibirDireccionFisicaYPID(conexionKernel, logger);

    log_info(logger, "PID: <%d> - Operacion: <FS_DELETE>", peticion.PID);
...
void ejecutarFS_TRUNCATE(t_log* logger, int conexionKernel, int conexionMemoria)
{
    /*
    t_peticion_std peticion = recibirDireccionFisicaYPID(conexionKernel, logger);
    
    log_info(logger, "PID: <%d> - Operacion: <FS_TRUNCATE>", peticion.PID);
